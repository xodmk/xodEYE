...
sigma_est = np.mean(estimate_sigma(eye01, channel_axis=-1))
...
denoise = denoise_nl_means(eye01, h=blurThresh * sigma_est, fast_mode=True, **patch_kw)
denoise_ubyte = img_as_ubyte(denoise)
denoise_gray = grayConversion(denoise_ubyte)
